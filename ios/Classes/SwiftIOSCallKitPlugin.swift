...
public class SwiftIOSCallKitPlugin: NSObject {
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let plugin = SwiftIOSCallKitPlugin(messenger: registrar.messenger())
    ...
    private func testIncomingCall(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        guard let args = call.arguments as? [String: Any],
            ...
            let callerId = args["callerId"] as? String,
            let videoType = args["videoType"] as? Bool,
...
extension SwiftIOSCallKitPlugin: UNUserNotificationCenterDelegate {
...
extension SwiftIOSCallKitPlugin: FlutterPlugin {
