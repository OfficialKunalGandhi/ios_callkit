...
class CallKitCenter: NSObject {
    ...
    override init() {
        if let path = Bundle.main.path(forResource: "Info", ofType: "plist") {
            ...
            self.iconName = plist?["FIVKIconName"] as? String ?? "IOS CallKit"
    ...
    func incomingCall(uuidString: String, callerId: String, callerName: String,videoType: Bool ,completion: @escaping (Error?) -> Void) {
