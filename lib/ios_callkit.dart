...
class IOSCallKit {
  static IOSCallKit get instance => _getInstance();
  static IOSCallKit? _instance;
  static IOSCallKit _getInstance() {
    if (_instance == null) {
      _instance = IOSCallKit._internal();
    }

    return _instance!;
  }

  factory IOSCallKit() => _getInstance();

  IOSCallKit._internal() {
